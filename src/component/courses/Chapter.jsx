...
import {
  changeProgress,
  changeCompleted,
} from "../../Redux/reducer/ProgressSlice";
...
const Chapter = () => {
  ...
  useEffect(() => {
  setTimeout(()=>{ // it is only for show the functionality of loader
    let arrdata = getData();
    let dummyTopic_name;
    let dummyexcercise;
        ...
        <TabContext value={value}>
          ...
          <TabPanel value="1">
            {Chapter_name === undefined ? (
              <Stack
                sx={{ color: "grey.500", marginTop: "10em" }}
                        ...
                        >
                          ...
                          <div className="select_chapter">
                            <input
                              ...
                              name="my-checkbox"
                              defaultChecked={
                                courseProcess.completed_topic.includes(
                                  data.video_name
                                )
                                  ? true
                                  : false
